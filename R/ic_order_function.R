...
#' @param log If TRUE, the scale of the y-axis will be plotted logarithmically. Default to FALSE.
#' @return Barplot showing the ordered information criteria of the tested models.
#' @export
#' @examples
...
ic.order <- function(input = getwd(), mrun = NULL, number = NULL, ic = "AICc", colour.par = NULL, save.output = NULL, log = FALSE){
  ...
  graphics::barplot(as.numeric(aicc),
                    col = row.colours,
